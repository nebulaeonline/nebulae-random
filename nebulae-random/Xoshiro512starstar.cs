...
{
    public class Xoshiro512starstar : BaseRng
    {
        ...
        {
            Xoshiro512starstar copy;

            lock (_lock)
            {
                copy = new Xoshiro512starstar(); // testing constructor; does not reseed
        ...
        /// <summary>
        /// Xoshiro512starstar() constructs the rng object and seeds the rng
        ...
        /// <summary>
        /// Xoshiro512starstar() constructs the rng object and seeds the rng with the given 8 64-bit unsigned integers
        /// </summary>
        ...
        /// <returns>the constructed & seeded rng</returns>
        public Xoshiro512starstar(ulong[] seeds, bool ignoreNot8ULongs = false)
        {
            Reseed(seeds, ignoreNot8ULongs);
        }

        /// <summary>
        /// Xoshiro512starstar() constructs the rng object and seeds the rng with the given 64 bytes. This constructor
        ...
        public Xoshiro512starstar(byte[] seed)
        {
            Reseed(seed);
        }
