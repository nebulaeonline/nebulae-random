...
{
    public class Xoshiro256starstar : BaseRng
    {
        ...
        {
            Xoshiro256starstar copy;

            lock (_lock)
            {
                copy = new Xoshiro256starstar(); // testing constructor; does not reseed
        ...
        /// <summary>
        /// Xoshiro256starstar() constructs the rng object and seeds the rng
        ...
        /// <summary>
        /// Xoshiro256starstar() constructs the rng object and seeds the rng with the given 4 64-bit unsigned integers
        /// </summary>
        ...
        /// <returns>the constructed & seeded rng</returns>
        public Xoshiro256starstar(ulong[] seeds, bool ignoreNot4ULongs = false)
        {
            Reseed(seeds, ignoreNot4ULongs);
        }

        /// <summary>
        /// Xoshiro256starstar() constructs the rng object and seeds the rng with the given 32 bytes. This constructor
        ...
        /// <summary>
        /// Xoshiro256starstar() constructs the rng object and seeds the rng object with the given 4 64-bit unsigned integers
        /// </summary>
        ...
        public override ulong NextRaw64()
        {
            lock (_lock)
            {
                var result = rotl(_state[1] * 5, 7) * 9;
