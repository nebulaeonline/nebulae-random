...
{
    public class Xoshiro256plus : BaseRng
    {
        ...
        public override INebulaeRng Clone()
        {
            ...
            lock (_lock)
            {
                copy = new Xoshiro256plus(); // testing constructor; does not reseed
        ...
        /// <summary>
        /// Xoshiro256plus() constructs the rng object and seeds the rng
        ...
        /// <summary>
        /// Xoshiro256plus() constructs the rng object and seeds the rng with the given 4 64-bit unsigned integers
        /// </summary>
        ...
        /// <returns>the constructed & seeded rng</returns>
        public Xoshiro256plus(ulong[] seeds, bool ignoreNot4ULongs = false)
        {
            Reseed(seeds, ignoreNot4ULongs);
        }

        /// <summary>
        /// Xoshiro256plus() constructs the rng object and seeds the rng with the given 32 bytes. This constructor
        ...
        public Xoshiro256plus(byte[] seed)
        {
            Reseed(seed);
        }

        /// <summary>
        /// Xoshiro256plus() constructs the rng object and seeds the rng object with the given 4 64-bit unsigned integers
        /// </summary>
