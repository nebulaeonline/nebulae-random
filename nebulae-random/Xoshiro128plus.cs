...
{
    public class Xoshiro128plus : BaseRng
    {
        ...
        public override INebulaeRng Clone()
        {
            ...
            lock (_lock)
            {
                copy = new Xoshiro128plus(); // testing constructor; does not reseed
        ...
        /// <summary>
        /// Xoshiro128plus() constructs the rng object and seeds the rng
        ...
        /// <summary>
        /// Xoshiro128plus() constructs the rng object and seeds the rng with the given 2 64-bit unsigned integers
        /// </summary>
        ...
        /// <returns>the constructed & seeded rng</returns>
        public Xoshiro128plus(ulong[] seeds, bool ignoreNot2ULongs = false)
        {
            Reseed(seeds, ignoreNot2ULongs);
        }

        /// <summary>
        /// Xoshiro128plus() constructs the rng object and seeds the rng with the given 16 bytes. This constructor
        ...
        public Xoshiro128plus(byte[] seed)
        {
            Reseed(seed);
        }

        /// <summary>
        /// Xoshiro128plus() constructs the rng object and seeds the rng object with the given 2 64-bit unsigned integers
        /// </summary>
        ...
        public Xoshiro128plus(ulong seed1, ulong seed2)
        {
            Reseed(seed1, seed2);
        }
