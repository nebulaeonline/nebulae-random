...
{
    public class Xoshiro1024starstar : BaseRng
    {
        ...
        {
            Xoshiro1024starstar copy;

            lock (_lock)
            {
                copy = new Xoshiro1024starstar(); // testing constructor; does not reseed
        ...
        /// <summary>
        /// Xoshiro1024starstar() constructs the rng object and seeds the rng
        ...
        public Xoshiro1024starstar()
        {
            Reseed();
        }

        /// <summary>
        /// Xoshiro1024starstar() constructs the rng object and seeds the rng with the given 16 64-bit unsigned integers
        /// </summary>
        /// <param name="seed">ulong[] seed - the seeds, as an array of 16 64-bit unsigned integers, to use to seed the rng</param>
        ...
        /// <returns>the constructed & seeded rng</returns>
        public Xoshiro1024starstar(ulong[] seeds, bool ignoreNot8ULongs = false)
        {
            Reseed(seeds, ignoreNot8ULongs);
        }

        /// <summary>
        /// Xoshiro1024starstar() constructs the rng object and seeds the rng with the given 128 bytes. This constructor
        ...
        public Xoshiro1024starstar(byte[] seed)
        {
            Reseed(seed);
        }
