...
{
    public class Xoshiro1024plusplus : BaseRng
    {
        ...
        {
            Xoshiro1024plusplus copy;

            lock (_lock)
            {
                copy = new Xoshiro1024plusplus(); // testing constructor; does not reseed
        ...
        /// <summary>
        /// Xoshiro1024plusplus() constructs the rng object and seeds the rng
        ...
        public Xoshiro1024plusplus()
        {
            Reseed();
        }

        /// <summary>
        /// Xoshiro1024plusplus() constructs the rng object and seeds the rng with the given 16 64-bit unsigned integers
        /// </summary>
        ...
        /// <returns>the constructed & seeded rng</returns>
        public Xoshiro1024plusplus(ulong[] seeds, bool ignoreNot8ULongs = false)
        {
            Reseed(seeds, ignoreNot8ULongs);
        }

        /// <summary>
        /// Xoshiro1024plusplus() constructs the rng object and seeds the rng with the given 128 bytes. This constructor
        ...
        public Xoshiro1024plusplus(byte[] seed)
        {
            Reseed(seed);
        }
