...
{
    public class Xoshiro128plusplus : BaseRng
    {
        ...
        {
            Xoshiro128plusplus copy;

            lock (_lock)
            {
                copy = new Xoshiro128plusplus(); // testing constructor; does not reseed
        ...
        /// <summary>
        /// Xoshiro128plusplus() constructs the rng object and seeds the rng
        ...
        public Xoshiro128plusplus()
        {
            Reseed();
        }

        /// <summary>
        /// Xoshiro128plusplus() constructs the rng object and seeds the rng with the given 2 64-bit unsigned integers
        /// </summary>
        /// <param name="seedULongs">ulong[] SeedULongs - the seed, as an array of 2 64-bit unsigned integers, to use to seed the rng</param>
        ...
        /// <returns>the constructed & seeded rng</returns>
        public Xoshiro128plusplus(ulong[] seeds, bool ignoreNot2ULongs = false)
        {
            Reseed(seeds, ignoreNot2ULongs);
        }

        /// <summary>
        /// Xoshiro128plusplus() constructs the rng object and seeds the rng with the given 16 bytes. This constructor
        ...
        public Xoshiro128plusplus(byte[] seed)
        {
            Reseed(seed);
        }

        /// <summary>
        /// Xoshiro128plusplus() constructs the rng object and seeds the rng object with the given 2 64-bit unsigned integers
        /// </summary>
        ...
        public Xoshiro128plusplus(ulong seed1, ulong seed2)
        {
            Reseed(seed1, seed2);
        }
        ...
        /// </summary>
        /// <param name="seeds">ulong[] seeds - the seed, as an array of 2 64-bit unsigned integers, to use to seed the rng</param>
        /// <param name="ignoreNot2ULongs">bool ignoreNot2ULongs - don't throw an exception if an undersized or oversized array is passed</param>
