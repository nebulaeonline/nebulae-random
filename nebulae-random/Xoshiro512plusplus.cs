...
{
    public class Xoshiro512plusplus : BaseRng
    {
        ...
        {
            Xoshiro512plusplus copy;

            lock (_lock)
            {
                copy = new Xoshiro512plusplus(); // testing constructor; does not reseed
        ...
        /// <summary>
        /// Xoshiro512plusplus() constructs the rng object and seeds the rng
        ...
        /// <summary>
        /// Xoshiro512plusplus() constructs the rng object and seeds the rng with the given 8 64-bit unsigned integers
        /// </summary>
        ...
        /// <returns>the constructed & seeded rng</returns>
        public Xoshiro512plusplus(ulong[] seeds, bool ignoreNot8ULongs = false)
        {
            Reseed(seeds, ignoreNot8ULongs);
        }

        /// <summary>
        /// Xoshiro512plusplus() constructs the rng object and seeds the rng with the given 64 bytes. This constructor
        ...
        public Xoshiro512plusplus(byte[] seed)
        {
            Reseed(seed);
        }
        ...
        /// <param name="seeds">ulong[] seeds - the seeds, as an array of 8 64-bit unsigned integers, to use to seed the rng</param>
        /// <param name="ignoreNot8ULongs">bool ignoreNot4ULongs - don't throw an exception if an undersized or oversized array is passed</param>
        public void Reseed(ulong[] seeds, bool ignoreNot8ULongs = false)
        {
        ...
        public override ulong NextRaw64()
        {
            lock (_lock)
            {
                var result = rotl(_state[0] + _state[2], 17) + _state[2];
